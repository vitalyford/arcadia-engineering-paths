...
const BreadcrumbButton = ({
  ...
  <button
    onClick={onClick}
    disabled={!isEnabled}
    className={`px-3 py-1.5 rounded-full whitespace-nowrap transition-colors ${isActive
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-700 text-sm leading-relaxed mb-3">
                          ...
                          Simply select <span className="text-primary font-semibold">Arcadia University</span> in the <span className="font-medium">&quot;Current School&quot;</span> input field and fill out the form.
                        </p>
                        {selected.university.downloadableForm && (
                          <a
                            href={selected.university.downloadableForm.path}
                            target={selected.university.downloadableForm.path.startsWith('http') ? "_blank" : undefined}
                            rel={selected.university.downloadableForm.path.startsWith('http') ? "noopener noreferrer" : undefined}
                            download={!selected.university.downloadableForm.path.startsWith('http')}
                          ...
                          >
                            {selected.university.downloadableForm.path.startsWith('http') ? (
                            ...
                            {selected.university.downloadableForm.path.startsWith('http') ? 'Fill out' : 'Download'} {selected.university.downloadableForm.name}
                          </a>
                        )}
                      </div>
                    </div>
